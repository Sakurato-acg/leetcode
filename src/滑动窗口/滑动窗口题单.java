...
//        solution.countCompleteSubstrings("igigee", 2);
    }
}
...
class Solution1 {
    ...
    //[包含子区间的任意排列] 567. 字符串的排列 https://leetcode.cn/problems/permutation-in-string/description/
    ...
    //[包含子区间的任意排列] 438. 找到字符串中所有字母异位词 https://leetcode.cn/problems/find-all-anagrams-in-a-string/
